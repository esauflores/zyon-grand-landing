      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Experience the vision and excellence behind Zyon Grand
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="relative w-full h-0 pb-[56.25%] rounded-3xl overflow-hidden shadow-2xl border-4 border-white">
            <iframe
              ...
              src="https://www.youtube.com/embed/72O7vsYaczw?rel=0&modestbranding=1&showinfo=0"
              title="Zyon Grand Home Video"
